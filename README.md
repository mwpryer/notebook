...
This project was inspired by and is an extension to the initial project from Stephen Grider's Udemy course [React and Typescript: Build a Portfolio Project](https://www.udemy.com/course/react-and-typescript-build-a-portfolio-project).
